...
class App extends React.Component {
    ...
    render = () => {
        ...
        return (
            <main className="main">
                <Cities autocomplete={regions} add={addCity} remove={removeCity} edit={editCity} user={user}
                        data={cities} currCity={currCity} focus={getCurrentCity}/>
                <Detail getCities={getCities} getCity={getCurrentCity} allAttrs={allAttrs} addAttr={addAttr}
                        resetCity={resetCity} removeCity={removeCity}
                        removeAttr={removeAttr} editCity={editCity} editAttr={editAttr} detail={detail}
                        getDetail={getDetail} user={user}
